...
import com.example.newecoholiday.entity.WeatherObject;
import com.example.newecoholiday.helpers.CustomSharedPreference;
import com.example.newecoholiday.helpers.Helper;
import com.example.newecoholiday.json.FiveDaysForecast;
import com.example.newecoholiday.json.FiveWeathers;
import com.example.newecoholiday.json.Forecast;
import com.example.newecoholiday.json.LocationMapObject;
...
public class WeatherActivity extends AppCompatActivity implements LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cityPark = (TextView)findViewById(R.id.city_park);
        ...
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ...
            if(isLocationSaved.equals("")){
                ...
                if (locationManager != null) {
                    ...
                    apiUrl = "http://api.openweathermap.org/data/2.5/weather?lat="+Double.parseDouble(latitude)+"&lon="+Double.parseDouble(longitude)+"&APPID="+Helper.API_KEY+"&units=metric";
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, apiUrl, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (null == locationMapObject) {
                    ...
                    cityPark.setText(Html.fromHtml(park));
                    ...
                    if(null != weatherInfo){
                        for(int i = 0; i < weatherInfo.size(); i++){
                            ...
                            if(convertTimeToDay(time).equals("Mon") && everyday[0] < 1){
                                daysOfTheWeek.add(new WeatherObject(shortDay, R.drawable.weather_icon, temp, tempMin));
                                everyday[0] = 1;
                            }
